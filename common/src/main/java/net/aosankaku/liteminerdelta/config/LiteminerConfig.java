    ...
    public LiteminerConfig(ConfigBuilder builder) {
        builder.push("safety")
                ...
                .categoryInfo(info -> info
                        .headerKey("liteminer_delta.config.info.safety.header")
                        .inlineTextKey("liteminer_delta.config.info.safety.text"))
                .header("Safety");
        preventToolBreaking = builder.bool("prevent_tool_breaking", true)
                .comment("Stops vein mining before the active tool breaks.")
                .info(info -> info.inlineTextKey("liteminer_delta.config.prevent_tool_breaking.info"))
                .sync(true)
                .build();
        requireCorrectToolEnabled = builder.bool("require_correct_tool_enabled", false)
                ...
                .info(info -> info.inlineTextKey("liteminer_delta.config.require_correct_tool_enabled.info"))
                .sync(true)
                .build();
        builder.pop();
        ...
        builder.push("limits")
                ...
                .categoryInfo(info -> info
                        .headerKey("liteminer_delta.config.info.limits.header")
                        .inlineTextKey("liteminer_delta.config.info.limits.text"))
                .header("Limits");
        blockBreakLimit = builder.intRange("block_break_limit", 64, 1, 2048)
                ...
                .info(info -> info.inlineTextKey("liteminer_delta.config.block_break_limit.info"))
                .sync(true)
                .build();
        builder.pop();
        ...
        builder.push("harvest")
                ...
                .categoryInfo(info -> info
                        .headerKey("liteminer_delta.config.info.harvest.header")
                        .inlineTextKey("liteminer_delta.config.info.harvest.text"))
                .header("Harvest Cost");
        harvestTimePerBlockModifierEnabled =
                builder.bool("harvest_time_per_block_modifier_enabled", true)
                        ...
                        .info(info -> info.inlineTextKey("liteminer_delta.config.harvest_time_per_block_modifier_enabled.info"))
                        .sync(true)
                        .build();
        harvestTimePerBlockModifier = builder.doubleRange("harvest_time_per_block_modifier", 2d, 1.0d, 10d)
                ...
                .info(info -> info.inlineTextKey("liteminer_delta.config.harvest_time_per_block_modifier.info"))
                .sync(true)
                .build();
        ...
        foodExhaustionEnabled = builder.bool("food_exhaustion_enabled", true)
                ...
                .info(info -> info.inlineTextKey("liteminer_delta.config.food_exhaustion_enabled.info"))
                .sync(true)
                .build();
        foodExhaustion = builder.doubleRange("food_exhaustion", 0.2d, 0.0d, 1d)
                ...
                .info(info -> info.inlineTextKey("liteminer_delta.config.food_exhaustion.info"))
                .sync(true)
                .build();
        allowVeinMiningAtZeroHunger = builder.bool("allow_vein_mining_at_zero_hunger", false)
                ...
                .info(info -> info.inlineTextKey("liteminer_delta.config.allow_vein_mining_at_zero_hunger.info"))
                .sync(true)
                .build();
        builder.pop();
        ...
        distinguishGrownCrops = builder.bool("distinguish_grown_crops", true)
                ...
                .info(info -> info.inlineTextKey("liteminer_delta.config.distinguish_grown_crops.info"))
                .sync(true)
                .build();
