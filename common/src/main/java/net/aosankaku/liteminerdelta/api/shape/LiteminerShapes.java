...
import net.aosankaku.liteminerdelta.shapes.StaircaseDownWalker;
import net.aosankaku.liteminerdelta.shapes.StaircaseUpWalker;
import net.aosankaku.liteminerdelta.shapes.ThreeByThreeWalker;
import net.aosankaku.liteminerdelta.shapes.TunnelWalker;
...
public final class LiteminerShapes {
    ...
    static {
        ...
        register(SHAPELESS, Component.translatable("shape.liteminer_delta.shapeless"), new ShapeWalker() {
            @Override
            public HashSet<BlockPos> walk(Level level, Player player, BlockPos origin) {
                return shapelessWalker.walk(level, player, origin);
            }

            @Override
            public HashSet<BlockPos> walk(
                    Level level,
                    Player player,
                    BlockPos origin,
                    boolean distinguishDeepslateOres
            ) {
                return shapelessWalker.walk(level, player, origin, distinguishDeepslateOres);
            }
        ...
        register(SMALL_TUNNEL, Component.translatable("shape.liteminer_delta.small_tunnel"), new TunnelWalker()::walk);
        register(STAIRCASE_UP, Component.translatable("shape.liteminer_delta.staircase_up"), new StaircaseUpWalker()::walk);
        register(STAIRCASE_DOWN, Component.translatable("shape.liteminer_delta.staircase_down"), new StaircaseDownWalker()::walk);
        register(THREE_BY_THREE, Component.translatable("shape.liteminer_delta.three_by_three"), new ThreeByThreeWalker()::walk);
    }
