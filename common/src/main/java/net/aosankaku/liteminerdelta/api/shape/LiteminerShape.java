...
public record LiteminerShape(Identifier id, Component displayName, ShapeWalker walker) {
    ...
    public HashSet<BlockPos> walk(Level level, Player player, BlockPos origin,
        ...
        return walker.walk(level, player, origin, distinguishDeepslateOres);
    }

    public HashSet<BlockPos> walk(Level level, Player player, BlockPos origin,
            boolean distinguishDeepslateOres, boolean distinguishStoneVariants) {
        return walker.walk(level, player, origin, distinguishDeepslateOres, distinguishStoneVariants);
    }
